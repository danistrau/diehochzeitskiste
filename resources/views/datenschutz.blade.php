        ...
        <div class="main">
            <div>
                ...
                <h2>Impressum</h2>
                    ...
                    <p>Daniela Strauss</p>
                    <p>Wien, Österreich</p>
                    <p> E-Mail: dani_strau@yahoo.de</p>
                    <p> Quelle: Erstellt mit dem Impressum Generator von adsimple.at in Kooperation mit trigital.at</p>
                    ...
                    Haftung für verlinkte Websites
                    ...
                    Fotos, Texte, Videos) unterliegen dem Urheberrecht. Falls
                    notwendig, werden wir die unerlaubte Nutzung von Teilen der
                    Inhalte unserer Seite rechtlich verfolgen. Sollten Sie auf
                    dieser Webseite Inhalte finden, die das Urheberrecht
                    verletzen, bitten wir Sie uns zu kontaktieren.
                    <h3>Bildernachweis</h3>
                    Die Bilder, Fotos und Grafiken auf dieser
                    Webseite sind urheberrechtlich geschützt. Die Bilderrechte
                ...
                <p>
                    ...
                    08.11.2019-121194885) verfasst, um Ihnen gemäß der Vorgaben
                    der Datenschutz-Grundverordnung (EU) 2016/679 und dem
                    Datenschutzgesetz (DSG) zu erklären, welche Informationen
                    ...
                    <h3>Automatische Datenspeicherung</h3>
                     Wenn Sie heutzutage Webseiten besuchen,
                    ...
                    (Referrer URL) den Hostname und die IP-Adresse des Geräts
                    von welchem aus zugegriffen wird Datum und Uhrzeit in
                    Dateien (Webserver-Logfiles). In der Regel werden
                    Webserver-Logfiles zwei Wochen gespeichert und danach
                    automatisch gelöscht. Wir geben diese Daten nicht weiter,
                    können jedoch nicht ausschließen, dass diese Daten beim
                    Vorliegen von rechtswidrigem Verhalten eingesehen werden.
                    <h3>Cookies</h3> 
                    Unsere Webseite verwendet HTTP-Cookies, um
                    nutzerspezifische Daten zu speichern. Im Folgenden erklären
                    wir, was Cookies sind und warum Sie genutzt werden, damit
